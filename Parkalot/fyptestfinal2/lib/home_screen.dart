...
class HomePage extends StatefulWidget {
  ...
  final int userId; // Add the userId parameter here
...
class _BookingPageState extends State<BookingPage> {
 ...
 // Price from API
  ...
  Widget _buildBookingCard(BuildContext context, String location, String size,
      String price, int parkingId) {
    return Card(
      elevation: 8,
  ...
  Future<void> fetchParkingDetails() async {
    try {
      ...
      Map<String, dynamic> response =
          await ApiService.getParkingById(widget.parkingId);
